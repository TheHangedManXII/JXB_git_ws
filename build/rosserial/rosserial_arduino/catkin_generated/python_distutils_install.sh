...
echo_and_run cd "/home/sdfg/JXB_git_ws/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/sdfg/JXB_git_ws/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/sdfg/JXB_git_ws/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
